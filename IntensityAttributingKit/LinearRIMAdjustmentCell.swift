...
final class LinearRIMAdjustmentCell:RawIntensityAdjustmentCellBase {
    ...
    override init() {
        ...
        thresholdSV.slider.addTarget(self, action: #selector(LinearRIMAdjustmentCell.updateRIM(_:)), forControlEvents: .ValueChanged)
        ...
        ceilingSV.slider.addTarget(self, action: #selector(LinearRIMAdjustmentCell.updateRIM(_:)), forControlEvents: .ValueChanged)
