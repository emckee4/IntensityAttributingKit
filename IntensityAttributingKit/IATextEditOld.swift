...
public class IATextEditOld: IATextView, IAAccessoryDelegate {
...
//    
    ...
    ///This is the viewcontroller which is/will display the IATextEditOld. We need to keep a week reference so that the accessory can present a UIPhotoPicker in the correct view hierarchy. This violates MVC but makes the IntensityAttributingKit more self contained.
