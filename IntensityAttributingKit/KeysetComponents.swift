...
/**
The current version of IAKeyset and its associatated types is built for the simplest layout of the IAKeyboard in which we only worry about changing the keys of the q, a, and z rows, and we only use single character keys (no expanding keys or function-triggering keys) throughout. 
 ...
 function (or closure) triggering keys,
